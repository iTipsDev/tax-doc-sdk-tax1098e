...
import irs.fdxtax641.jsonserializers.Tax1098ESerializer;
import irs.fdxtax641.map2objects.Map2Tax1098E;
import org.taxdataexchange.core.pdfbuilders.Tax1098EPdfBuilder;
...
public class Tax1098EDocumentGenerator {
    ...
    private void processOneRow(
        ...
        Tax1098E obj = Map2Tax1098E.generate( row );
        {
            String asJson = Tax1098ESerializer.serialize( obj );
    ...
    private void processCsvForCompany(
        ...
        // CSV file
        String csvFileName  = "Tax1098E.csv";
        ...
        String outputFileName = "Tax1098E.rows.json";
    ...
    public static void main(String[] args) {
        ...
        Tax1098EDocumentGenerator generator = new Tax1098EDocumentGenerator( );
